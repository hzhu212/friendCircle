...
<body>
	...
	<%
		...
		if(userFriends.size()==0){
			out.print("<div id=\"friends\">"+"<h2>您尚未添加好友</h2>"+"</div>");
		}
		else{
			out.print("<div id=\"friends\">"+"<h2>您的好友信息为：</h2>"+"</div>");
		}
		//有好友
		for(int i=0;i<userFriends.size();i++){
			String[] temp=userApi.getUserFromId(userFriends.get(i));
			out.print("<div id=\"friends\">"
